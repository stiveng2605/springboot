...
public class servicioUsuario {
    ...
    public servicioUsuario() {
        ...
        lista.add(new Usuario(10,"Mateo","Mexico", LocalDate.of(2022,05,18), "mateo@gmail.com"));
        lista.add(new Usuario(10,"Valentina","Rusia", LocalDate.of(2020,03,25), "valen@gmail.com"));
    }
